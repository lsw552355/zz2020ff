...
var config = function () {
	...
	return {
		...
		dialogue: [{ type: 6, name: 'ZZ', txt: 'FF小姐姐，我可以问你一个小问题吗？' }, { type: 2, name: 'FF', txt: '爪子问题？' }, { type: 2, name: 'FF', txt: '你问吧！' }, { type: 6, name: 'ZZ', txt: '有个三好的书你读过没？' }, { type: 6, name: 'ZZ', txt: '一本很有意思的书。' }, { type: 2, name: 'FF', txt: '没有呀～' }, { type: 6, name: 'ZZ', txt: '就是，你好漂亮、你好可爱、遇见你真好，哈哈哈' }, { type: 2, name: 'FF', txt: '。。。' }, { type: 2, name: 'FF', txt: '你又套路我。。。。' }, { type: 6, name: 'ZZ', txt: '别慌。' }, { type: 2, name: 'FF', txt: '。。。。。' }, { type: 6, name: 'ZZ', txt: '天快黑了，我要为你点燃整片天空。' }],
		// 阶段二
		sunset: 8000,
